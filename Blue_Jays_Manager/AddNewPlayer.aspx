    ...
    <div id="addPlayerFormDiv" class="form-horizontal" style=" margin-right: 30px; ">
        ...
        <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:DropDownList ID="dobMonthDropDownList" runat="server" OnSelectedIndexChanged="dobMonthDropDownList_SelectedIndexChanged"></asp:DropDownList>
                <asp:DropDownList ID="dobDayDropDownList" runat="server" OnSelectedIndexChanged="dobDayDropDownList_SelectedIndexChanged"></asp:DropDownList>
                <asp:DropDownList ID="dobYearDropDownList" runat="server"></asp:DropDownList>
            </div>
        </div>
        ...
        <div class="form-group pull-right">
            <div class="col-md-12">
                <input id="Resetbtn" type="reset" class="btn btn-default" style="width: 90px"  value="reset" />
                 <asp:Button runat="server" Text="Add Coach" CssClass="btn btn-primary" style="width: 90px"  ID="AddCoachButton"/>
